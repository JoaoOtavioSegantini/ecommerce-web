    ...
    <Form onSubmit={handleSubmit}>
      <BlueBackground>
        ...
        <div className={styles.payment}>
          <div>
            ...
            <small className="d-block">Até 12x sem juros no cartão</small>
          </div>
                  ...
                  <Row>
                    <Col>
                      ...
                      >
                        ...
                        {MonthsService.execute().map((month, index) => (
      ...
      <BlueBackground>
        <div>
          ...
          <strong className="float-right"> {`R$ ${total.toFixed(2)}`}</strong>
        </div>
